...
DROP DATABASE IF EXISTS customer_shopping_behavior;
...
-- 6.  which 5 products have the the highest percentage of purchases with discount applied?
SELECT item_purchased, 
ROUND(SUM(CASE WHEN discount_applied = 'YES' THEN 1 ELSE 0 END)*1.0 /COUNT(*) * 100, 2) AS discount_rate
FROM customer
GROUP BY item_purchased
